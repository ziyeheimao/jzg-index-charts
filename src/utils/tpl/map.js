...
geoCoordMap['九寨沟'] = [103.9266619002, 33.1852083851]

var GZData = []
var tempData = ['九寨沟', GZData]
var maxValue = 0
    ...
    label: {
      normal: {
        ...
        formatter: function (params) {
          ...
          var number = (v / maxValue * 100).toFixed(1) + '%'
          // var number =
          // '{b}\n{c}',
          return number + '\n' + name + '\n' + v
        }
  ...
  tooltip: {
    ...
    formatter: function (params) {
      if (params.seriesType == 'scatter' && params.name != tempData[0]) {
        return params.data.name + '<br />办件数量：' + params.data.value[2]
      } else if (params.seriesType == 'lines') {
        return params.data.toName + '<br />办件数量：' + params.data.value
      } else {
        return params.name
      }
    }
    ...
    itemStyle: {
      normal: {
        ...
        areaColor: {
          ...
          colorStops: [{
            offset: 0,
            color: 'rgba(15, 38, 90, 1)' // 0% 处的颜色
          }, {
            offset: 1,
            color: 'rgba(15, 38, 90, .8)' // 100% 处的颜色
          }],
